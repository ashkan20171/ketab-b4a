...
public class starter extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ir.seyed.blog", "ir.seyed.blog.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.seyed.blog.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
