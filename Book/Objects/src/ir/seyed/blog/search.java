...
public class search extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ir.seyed.blog", "ir.seyed.blog.search");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.seyed.blog", "ir.seyed.blog.search");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.seyed.blog.search", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 19;BA.debugLine="Activity.LoadLayout(\"search\")";
mostCurrent._activity.LoadLayout("search",mostCurrent.activityBA);
 //BA.debugLineNum = 20;BA.debugLine="load";
_load();
...
public static String  _edittext1_textchanged(String _old,String _new) throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Sub EditText1_TextChanged (Old As String, New As S";
 //BA.debugLineNum = 39;BA.debugLine="L.Clear";
mostCurrent._l.Clear();
 //BA.debugLineNum = 40;BA.debugLine="fara.SingleLineTitr(\"data.db\",list.SQL1,list.cur,";
_fara._singlelinetitr("data.db",mostCurrent._list._sql1,mostCurrent._list._cur,"SELECT * FROM tbl1 WHERE titr LIKE '%"+mostCurrent._edittext1.getText()+"%' ",mostCurrent._l,"titr","id");
 //BA.debugLineNum = 41;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 10;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 12;BA.debugLine="Private EditText1 As EditText";
mostCurrent._edittext1 = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Private L As ListView";
...
public static String  _l_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 32;BA.debugLine="Sub L_ItemClick (Position As Int, Value As Object)";
 //BA.debugLineNum = 33;BA.debugLine="list.meghdar=Value";
mostCurrent._list._meghdar = BA.ObjectToString(_value);
 //BA.debugLineNum = 34;BA.debugLine="StartActivity(\"text\")";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)("text"));
...
public static String  _load() throws Exception{
 //BA.debugLineNum = 23;BA.debugLine="Sub load";
 //BA.debugLineNum = 24;BA.debugLine="L.SingleLineLayout.Label.Gravity=Gravity.CENTER";
mostCurrent._l.getSingleLineLayout().Label.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 25;BA.debugLine="L.SingleLineLayout.Label.Typeface=Typeface.LoadFr";
mostCurrent._l.getSingleLineLayout().Label.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("iran sans.ttf"));
 //BA.debugLineNum = 26;BA.debugLine="L.SingleLineLayout.Label.TextSize = 15";
mostCurrent._l.getSingleLineLayout().Label.setTextSize((float) (15));
 //BA.debugLineNum = 27;BA.debugLine="L.SingleLineLayout.Label.TextColor=Colors.Black";
mostCurrent._l.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 28;BA.debugLine="L.SingleLineLayout.ItemHeight = 43dip";
